...
def main():
    ...
    #
    #             top_windows = p_rank_windows(P_map, window_size=wsize, top_k=top_k, decade_bonus=0.01)
...
def addDraws():
    # Set for Life
    def setForLife():
        add_draw(d(26, 12), "Set for Life", [1, 26, 20, 9, 22, 24, 3], [37, 23])
    ...
    # Weekday Windfall
    def weekdayWindfall():
        add_draw(d(26, 12), "Weekday Windfall", [36, 39, 11, 19, 28, 41], [45, 44])
