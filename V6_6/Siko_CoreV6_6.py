...
MIN_TRIALS =  7000          # minimum MC trials
...
def apply_prediction_config_overrides():
    ...
    print("Applying override config")
...
def build_targets_two_weeks_back():
    """
...
def main():
    ...
    if PREDICTION_CONFIG and PREDICTION_CONFIG['APPLY_PREDICTION_OVERRIDES'] :
...
def addDraws():
    ...
    # Weekday Windfall
    def weekdayWindfall():
        add_draw(d(12, 12), "Weekday Windfall", [33, 14, 8, 23, 9, 27], [4, 3])
        add_draw(d(15, 12), "Weekday Windfall", [10, 36, 45, 2, 15, 39], [25, 38])
