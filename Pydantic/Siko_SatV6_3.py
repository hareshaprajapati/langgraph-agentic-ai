...
# --- DATA: paste EXACTLY your current DATA block here ---

def addDraws():
    # Set for Life
    core.add_draw(core.d(11, 12), "Set for Life", [27, 12, 16, 3, 30, 8, 29], [41, 31])
    ...
    # Weekday Windfall
    core.add_draw(core.d(12, 12), "Weekday Windfall", [10, 36, 45, 2, 15, 39], [25,38])
    ...
    # Powerball
    core.add_draw(core.d(11, 12), "Powerball", [12, 23, 25, 16, 10, 5, 4], None, [10])
