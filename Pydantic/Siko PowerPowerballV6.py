...
TOP_N_PREDICTIONS = 2      # you can change this to print more/less predictions
...
LOTTERIES = {
    ...
    "Powerball":        {"main_draw_size": 1, "uses_supp": False, "uses_powerball": True},
...
PREDICTION_TARGET = ("Powerball", d(4,12), 1)
