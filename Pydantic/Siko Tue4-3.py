...
BASE_TRIALS = 6000         # base TRIALS factor before scaling
MIN_TRIALS = 4000          # minimum MC trials
...
TOP_N_PREDICTIONS = 1000      # you can change this to print more/less predictions
