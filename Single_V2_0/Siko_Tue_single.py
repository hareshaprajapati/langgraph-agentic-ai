...
def _tune_configs(
    ...
    configs = [
        {"name": "BASE", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": base_score, "penalty_config": {"dynamic_bands": False}, "generator": "standard"},
        {"name": "DECAY", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": decay_score, "penalty_config": {"dynamic_bands": False}, "generator": "standard"},
        {"name": "PAIR", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": pair_score, "penalty_config": {"dynamic_bands": False}, "generator": "standard"},
        {"name": "DYN_BANDS", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": base_score, "penalty_config": {"dynamic_bands": True}, "generator": "standard"},
        {"name": "PORTFOLIO", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": base_score, "penalty_config": {"dynamic_bands": False}, "generator": "portfolio"},
        {"name": "PAIR_ANCHOR", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": base_score, "penalty_config": {"dynamic_bands": False}, "generator": "pair_anchored"},
        {"name": "PAIR_CLUSTER", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": base_score, "penalty_config": {"dynamic_bands": False}, "generator": "pair_cluster"},
        {"name": "PAIR_CLUSTER_DYN", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": base_score, "penalty_config": {"dynamic_bands": True}, "generator": "pair_cluster"},
        {"name": "GRAPH_COVER", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": base_score, "penalty_config": {"dynamic_bands": False}, "generator": "graph_cover"},
        {"name": "GRAPH_COVER_DYN", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": base_score, "penalty_config": {"dynamic_bands": True}, "generator": "graph_cover"},
        {"name": "DECAY_PAIR", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": decay_pair_score, "penalty_config": {"dynamic_bands": False}, "generator": "standard"},
        {"name": "DECAY_PAIR_DYN", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": decay_pair_score, "penalty_config": {"dynamic_bands": True}, "generator": "standard"},
        {"name": "DECAY_PAIR_DYN_PORT", "pool": p36, "penalty_scale": 0.50, "cohesion": coh_soft, "score_config": decay_pair_score, "penalty_config": {"dynamic_bands": True}, "generator": "portfolio"},
    ]
...
def generate_graph_coverage_tickets(
    ...
    candidates: List[List[int]] = []
    candidate_target = min(PORTFOLIO_CANDIDATES, 2000)
