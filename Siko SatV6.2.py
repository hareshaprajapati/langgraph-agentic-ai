...
RUN_MODE = "prediction"   # change to "learning"
# RUN_MODE = "learning"   # change to "learning"
...
MIN_TRIALS = 1000          # minimum MC trials
MAX_TRIALS = 2000         # maximum MC trials
...
def apply_prediction_config_overrides():
    ...
    global CLUSTER_TRIAL_FRAC  # if you use this in your script
...
TARGET_DRAWS_FOR_LEARNING = [
    ("Saturday Lotto",   d(15,11)),
    ("Weekday Windfall", d(17,11)),   # adjust/remove if you don't have this data
    ("OZ Lotto",         d(18,11)),
    ("Weekday Windfall", d(19,11)),  # NOTE: you must ensure data exists for this date
    ("Powerball",        d(20,11)),
    ("Weekday Windfall", d(21,11)),
    ("Saturday Lotto",   d(22,11)),
    ("Weekday Windfall", d(24,11)),   # adjust/remove if you don't have this data
    ("OZ Lotto",         d(25,11)),
...
PREDICTION_TARGET = ("Saturday Lotto", d(6,12), 6)
# PREDICTION_TARGET = ("Saturday Lotto", d(29,11), 6)
# PREDICTION_TARGET = ("Saturday Lotto", d(22,11), 6)
...
def main():
    ...
    if RUN_MODE.lower().startswith("pred"):
    ...
    # --- Learning-only short-circuit ---------------------------------
    if RUN_MODE.lower().startswith("learn"):
        print("\n=== LEARNING-ONLY RUN COMPLETE (no prediction generated) ===")
        return
