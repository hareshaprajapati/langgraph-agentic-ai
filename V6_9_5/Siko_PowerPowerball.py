...
log_file_path = os.path.join(
    ".",
    f"siko_powerball_logs.log"  # single growing log file
)
...
if __name__ == "__main__":
    ...
    tuesday_dates = last_n_thursday(today, 6)
    # print(tuesday_dates)
    start_ts = time.time()
    start_dt = datetime.datetime.now()
    ...
    for target_date in reversed(tuesday_dates):
        ...
        core.PREDICTION_TARGET = ("Powerball", target_date, NUMBER_OF_POWERBALL)
        core.TARGET_DRAWS_FOR_LEARNING = core.build_targets_for_learning()
