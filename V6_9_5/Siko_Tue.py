...
COHORT_USAGE_CAP_FRAC = 0.30      # e.g. 0.40 to cap cohort repeats
COHORT_AUTOPRED_EVAL_LAST_N = None  # e.g. 2 or 3 for auto predictor window
OVERRIDE_COHORT_HWC = None          # e.g. (1, 3, 3)
OVERRIDE_COHORT_DECADES = None # {1:0, 2:4, 3:1, 4:1, 5:0}      # e.g. {1:1, 2:2, 3:1, 4:2, 5:1}
...
if __name__ == "__main__":
    ...
    for target_date in reversed(tuesday_dates):
        ...
        core.LOCKED_REGIME_LOTTERY = "OZ Lotto"
