...
BASE_TRIALS = 30000         # base TRIALS factor before scaling
MIN_TRIALS = 60000          # minimum MC trials
MAX_TRIALS = 90000         # maximum MC trials
...
def main():
    ...
    # Build index from whatever data the wrapper has loaded
    finalize_data()
    ...
    # After the main learning loop, before apply_prediction_config_overrides()
    print("\n=== LEARNING SUMMARY ===")
    ...
    if not APPLY_PREDICTION_OVERRIDES:
